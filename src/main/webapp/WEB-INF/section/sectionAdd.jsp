...
<body>
	...
	border-radius: 10px; box-shadow: 0 2px 10px #999;  margin:2% 0 0 0; padding-top: 5px;">
			<form onsubmit="return check();" action=SectionServlet?action=add  method="post" >
			<input type="text" name="sectionName" id="sectionId" style="width: 200px; height: 30px; margin-bottom: 10px; padding-left: 3px; border: 1px solid #999;border-radius: 4px;"placeholder="版块名称" /><br>
			<input type="text" name="level" id="levelId" style="width: 200px; height: 30px; margin-bottom: 16px;padding-left: 3px; border: 1px solid #999;border-radius: 4px;" placeholder="权限" /><br>
