...
&lt;%&ndash;<link rel="stylesheet" href="../Js/css.css" type="text/css" />&ndash;%&gt;
...
<div style="text-align: center;float:right; width:150px; height:300px;	background: white; box-shadow: 0 2px 10px #999;  margin-right:5%;">
	...
	<a class="mya" style="width:150px; height: 75px; float:right; line-height:75px;text-decoration:none;" href="/logout" >注销</a>
</div>
<%--
</body>
</html>--%>
